...
<head>
    ...
    <body id="tijelo">
        ...
        <main class="glavni">
                ...
                <div class="slika">
                    <a href="#velika" id="mala">
                        <figure class="mala">
                            <img src="http://drive.google.com/uc?export=view&id=1KZDeKgY6PtbIN_7OtynN0_XNIzbll3m1" alt="">
                        </figure>
                    </a>
                    <a href="#mala" id="velika">
                        <figure>
                            <img src="http://drive.google.com/uc?export=view&id=1KZDeKgY6PtbIN_7OtynN0_XNIzbll3m1" alt="">
                        </figure>
                    </a>
        ...
        <footer>
            <address>
                ...
                <a href="https://validator.w3.org/nu/?doc=https%3A%2F%2Fbarka.foi.hr%2FWebDiP%2F2021%2Fzadaca_02%2Faleja%2Fera.php">
